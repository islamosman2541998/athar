...
@section('content')
@include('site.includes.page-hero',['title'=>__('athar.jobs.title'),'kicker'=>__('athar.about.kicker'),'intro'=>__('athar.jobs.intro'),'image'=>asset('site/images/athar-team.png')])
