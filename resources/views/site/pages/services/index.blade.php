...
@if($partners->count())<section class="section section--compact"><div class="container"><div class="partners">@foreach($partners as $partner)<img src="{{ media_asset($partner->pathInView()) }}" alt="{{ $partner->title ?? '' }}" loading="lazy">@endforeach</div></div></section>@endif
@endsection
