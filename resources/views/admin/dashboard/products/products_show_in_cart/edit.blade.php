...
@section('title', trans('products_of_car_only.edit_product'))
@section('title_page', trans('products_of_car_only.edit_product',  ['name' =>   @$product->transNow?->title  ]) )
        ...
        <div class="row">
            <div class="col-12 m-3">
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.show_in_cart_product_list') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form class="row" method="post" action="{{route('admin.show_in_cart_product_update' , $product->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    {{-- show_in_cart ------------------------------------------------------------------------------------- --}}
                                                    <div class="col-12">
                                                        <label class="col-sm-2 col-form-label" for="available">{{ trans('admin.show_in_cart') }}</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="show_in_cart" type="checkbox" id="switch3show_in_cart" switch="success"  checked  value="1">
                                                            <label class="form-label" for="switch3show_in_cart" data-on-label=" @lang('admin.yes') " data-off-label=" @lang('admin.no')"></label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <select class="form-select form-select-sm select2" multiple name="categories[]">
                                                            ...
                                                            <option value="{{$val2->id}}"  
                                                                value="{{$val2->id}}" {{ old('categories.' . $key2) == $val2->id   ? 'selected' : '' }}>
                                                                >
