...
@section('title', trans('products_of_car_only.create'))
@section('title_page', trans('products_of_car_only.create'))
        ...
        <div class="row">
            <div class="col-12 m-3">
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ url(app()->getLocale() .  '/admin/show-in-cart-products/list') }}"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{  url(app()->getLocale() .  '/admin/show-in-cart-products/add')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="accordion-item border rounded">
                                            ...
                                            <div id="collapseTwo" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <label class="col-sm-12 col-form-label"
                                                               for="available">{{ trans('admin.show_in_cart') }}</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="show_in_cart"
                                                                   type="checkbox" id="switch5" switch="success"    {{old('feature') == 1 ? 'checked' : ''}}
                                                                   value="1">
                                                            <label class="form-label" for="switch5"
                                                                   data-on-label=" @lang('admin.yes') "
                                                                   data-off-label=" @lang('admin.no')"></label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-select form-select-sm select2" multiple
                                                                    name="categories[]">
                                                                <option value=""
                                                                        disabled> {{ trans('products.categories') }}</option>
                                                        ...
                                                        @if ($errors->has('categories'))
                                                            <span
                                                                class="missiong-spam">{{ $errors->first($locale . 'categories') }}</span>
                                                        @endif
                                                    </div>
