...
@section('title', trans('product_category.create'))
@section('title_page', trans('product_category.create'))
                                ...
                                <div class="accordion mt-4 mb-4 bg-primary" id="accordionExample_first{{ $locale }}">
                                    <div class="accordion-item border rounded">
                                        <h2 class="accordion-header" id="headingOne{{ $locale }}">
                                            <button class="accordion-button fw-medium " type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne_first{{ $locale }}" aria-expanded="true" aria-controls="collapseOne_first{{ $locale }}">
                                                {{ __('product_category.' . $locale) }}
                                            </button>
                                        </h2>
                                        <div id="collapseOne_first{{ $locale }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne_first{{ $locale }}" data-bs-parent="#accordionExample_first{{ $locale }}">
                                ...
                                <div class="accordion mt-4 mb-4 bg-primary" id="accordionExampleSlugs">
                                    <div class="accordion-item border rounded">
                                        <h2 class="accordion-header" id="headingOneSlugs">
                                            <button class="accordion-button fw-medium " type="button" data-bs-toggle="collapse" data-bs-target="#collapseOneSlugs" aria-expanded="true" aria-controls="collapseOneSlugs">
                                                {{ __('products.meta_info') }}
                                            </button>
                                        </h2>
                                        <div id="collapseOneSlugs" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOneSlugs" data-bs-parent="#accordionExampleSlugs">
                                            <div class="accordion-body">
                                ...
                                <div class="accordion mt-4 mb-4" id="accordionExample1">
                                    <div class="accordion-item border rounded">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingtwo" data-bs-parent="#accordionExample1">
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control" type="file" placeholder="@lang('products.main_image'):" id="example-number-input" name="image" value="{{ old('image') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                {{-- class="col-sm-2 col-form-label">{{ trans('products.code')  }}</label> --}}
                                                {{-- <div class="col-sm-10"> --}}
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="feature" type="checkbox" id="switch1" switch="success" {{ old('feature') == 1 ? 'checked' : '' }} value="1">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" value="1" {{ old('status') == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-check form-switch" name="annual_occasion" type="checkbox" id="switch2" switch="success" {{ old('annual_occasion') == 1 ? 'checked' : '' }} value="1">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-check form-switch" name="show_in_bottom" type="checkbox" id="switch6" switch="success" {{ old('show_in_bottom') == 1 ? 'checked' : '' }} value="1">
                                        ...
                                        {{-- disabled> {{ trans('products.occasions') }}</option> --}}
