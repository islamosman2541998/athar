        ...
        <div class="row">
            <div class="row">
                <div class="col-12 m-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="row" method="post" action="{{ route('admin.jobs.update', $job->id) }}"
                                ...
                                <div class="col-md-8">
                                    @foreach ($languages as $key => $locale)
                                        @php $trans = $job->trans->where('locale', $locale)->first(); @endphp
                                        @if ($trans)
                                                ...
                                                <div class="accordion-item border rounded">
                                                    ...
                                                    <div id="collapseOne{{ $key }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="example-text-input"
                                                                    class="col-sm-2 col-form-label"> @lang('admin.short_description_in')
                                                                    {{ trans('lang.' . Locale::getDisplayName($locale)) }}
                                                                </label>
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="short_description{{ $key }}" name="{{ $locale }}[short_description]"> {{ old($locale . '.short_description') ?? $trans->short_description }} </textarea>
                                                                    <script type="text/javascript">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="example-text-input"
                                                                    class="col-sm-2 col-form-label"> @lang('admin.requirements_in')
                                                                    {{ trans('lang.' . Locale::getDisplayName($locale)) }}
                                                                </label>
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="requirements{{ $key }}" name="{{ $locale }}[requirements]"> {{ old($locale . '.requirements') ?? $trans->requirements }} </textarea>
                                                                    <script type="text/javascript">
                                                    ...
                                                    <div id="collapseOne{{ $key }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="short_description{{ $key }}" name="{{ $locale }}[short_description]"> {{ old($locale . '.short_description') }} </textarea>
                                                                    <script type="text/javascript">
                                                                        CKEDITOR.replace('short_description{{ $key }}', {
                                                                            filebrowserUploadUrl: "{{ route('admin.ckeditor.upload', ['_token' => csrf_token()]) }}",
                                                                            filebrowserUploadMethod: 'form'
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="requirements{{ $key }}" name="{{ $locale }}[requirements]"> {{ old($locale . '.requirements') }} </textarea>
                                                                    <script type="text/javascript">
                                                                        CKEDITOR.replace('requirements{{ $key }}', {
                                                                            filebrowserUploadUrl: "{{ route('admin.ckeditor.upload', ['_token' => csrf_token()]) }}",
                                                                            filebrowserUploadMethod: 'form'
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <label for="example-number-email"
                                                                ...
                                                                @lang('products.employment_type')</label>
                                                            <div class="col-sm-6">
                                                                <input class="form-control" type="text"
                                                                    placeholder="@lang('products.employment_type')"
                                                                    name="employment_type"
                                                                    value="{{ $job->employment_type ?? old('code') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- location ------------------------------------------------------------------------------------- --}}
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <label for="example-number-email"
                                                                class="col-sm-6 col-form-label">
                                                                @lang('products.location')</label>
                                                            <div class="col-sm-6">
                                                                <input class="form-control" type="text"
                                                                    placeholder="@lang('products.location')" name="location"
                                                                    value="{{ $job->location ?? old('code') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- sort ------------------------------------------------------------------------------------- --}}
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="status"
                                                                ...
                                                                {{ $job->status == 1 || old('status') == 1 ? 'checked' : '' }}
                                                                value="1">
